...
@HiltViewModel
class DonationRatingViewModel @Inject constructor(private val donationRatingUseCase: DonationRatingUseCase) : ViewModel() {
    ...
    fun getDonationRating(foodDonateRatingDto: FoodDonateRatingDto?) {
        ...
        donationRatingUseCase.invoke(foodDonateRatingDto).onEach { result ->
