...
class ApiUrl {
    ...
    companion object {
        ...
        const val API_BASE_URL = "https://36ef-110-34-1-113.ngrok-free.app/"
        ...
        const val USER_ACCOUNT_VERIFY = "api/account/verify"
        ...
        // SECRET KEY
        const val TOKEN_SECRET_KEY = "django-insecure-=vti7ole*rh#$6!4szu-9d!uyc415@q=s%2i0+=pd1of*fo8qs"
        ...
        // DEFAULT IMAGE
        const val PROFILE_URL = "https://cdn-desktop-assets.evasyst.com/ui-defaults/evasyst-defaults/blank-profile.png"
