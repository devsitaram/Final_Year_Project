...
class FoodDetailRepositoryImpl(private val apiService: ApiService, private val roomDao: RoomDao) :
    ...
    override suspend fun updateFoodImage(foodId: Int?, fileImage: File?): FoodUpdatePojo? {
        ...
        val image = fileImage.let {
            MultipartBody.Part.createFormData("image", fileImage?.name ?: "food", requestFile ?: error("File is null"))
        }
